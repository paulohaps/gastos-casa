const CACHE_NAME = 'gastos-ape-v21';
const APP_VERSION = '20260919-014';

const PRECACHE = [
  './',
  './index.html',
  './css/style.css?v=20260919-014',
  './manifest.json',
  './js/api.js?v=20260919-014',
  './js/ui.js?v=20260919-014',
  './js/app.js?v=20260919-014'
];
