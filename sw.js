const CACHE_NAME = 'gastos-ape-v20';
const APP_VERSION = '20260919-013';

const PRECACHE = [
  './',
  './index.html',
  './css/style.css?v=20260919-013',
  './manifest.json',
  './js/api.js?v=20260919-013',
  './js/ui.js?v=20260919-013',
  './js/app.js?v=20260919-013'
];
