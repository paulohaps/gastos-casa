const CACHE_NAME = 'gastos-ape-v19';
const APP_VERSION = '20260919-012';

const PRECACHE = [
  './',
  './index.html',
  './css/style.css?v=20260919-012',
  './manifest.json',
  './js/api.js?v=20260919-012',
  './js/ui.js?v=20260919-012',
  './js/app.js?v=20260919-012'
];
