...
const PRECACHE = [
  ...
  './manifest.json',
  './js/core/utils.js?v=20260919-023',
...
async function networkFirst(request) {
  ...
  try {
    ...
    if (url.origin === self.location.origin && /\/js\/(?:core\/)?(?:modules\/)?(?:api|ui|app|utils|dashboard|smart-entry|radar|budgets|members|recurring|expenses)\.js$/.test(url.pathname)) {
